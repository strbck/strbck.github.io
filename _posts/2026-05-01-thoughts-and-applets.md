...
One of the neat things we've just started is developing some *very* simple HTML/JS applets, which I'll be posting on [this repo](https://github.com/strbck/simple-html). 
